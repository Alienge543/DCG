...
#                 train, _, test_novel = OxfordPets.subsample_classes(train, val, test, subsample='new')
#                 super().__init__(train_x=train, val=test_novel, test=test_novel)
#             else:
#                 print("===================================================>not SS")
#                 train, val, test = OxfordPets.subsample_classes(train, val, test, subsample='base')
