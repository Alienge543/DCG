...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.DCG = CN()
    cfg.TRAINER.DCG.N_CTX = 2  # number of context vectors
    cfg.TRAINER.DCG.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.DCG.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.DCG.PROMPT_DEPTH = 9
    cfg.DATASET.SUBSAMPLE_CLASSES = "all"  # all, base or new

    cfg.TRAINER.W = 8.0
#     cfg.TRAINER.DISTILL = "cosine"
    cfg.TRAINER.DCG.N_CTX_V = 2
    cfg.TRAINER.DCG.M = 4
    cfg.TRAINER.DCG.N_CTX = 4
    cfg.TRAINER.DCG.N = 4 
    cfg.TRAINER.DCG.MIX = 1
...
def setup_cfg(args):
    ...
    if cfg.DATASET.NAME in ['StanfordCars']:
...
if __name__ == "__main__":
    ...
    #parser.add_argument("--SS", action="store_true", help="self surpvised")
    parser.add_argument(
        "--model-dir",
        type=str,
        default="",
